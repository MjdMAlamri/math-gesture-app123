...
const EdVentureLanding = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      >
        <div style={styles.sectionContent}>
          <h2 style={{...styles.sectionTitle, marginBottom: 48}}>Solution</h2>
...
const styles = {
  ...
  hero: {
    ...
    backgroundImage: 'url(https://images.unsplash.com/photo-1758685734343-491353d96a81?q=80&w=2400&auto=format&fit=crop)',
